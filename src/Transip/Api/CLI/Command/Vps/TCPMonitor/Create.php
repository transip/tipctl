...
class Create extends AbstractCommand
{
    ...
    {
        $this->setName('vps:tcpmonitor:create')
            ->setDescription('Create a TCP Monitor for a VPS')
            ...
            ->addArgument(Field::TIME_FROM, InputArgument::OPTIONAL, Field::TIME_FROM__DESC . Field::OPTIONAL, null)
