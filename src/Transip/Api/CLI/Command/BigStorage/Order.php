...
class Order extends AbstractCommand
{
    ...
    protected function configure()
    {
        $this->setName('BigStorage:order')
            ...
            ->addArgument(self::BIGSTORAGE_OFFSITEBACKUPS, InputArgument::OPTIONAL, '(optional) Whether to order offsite backups, default is false.')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $bigStorageHasOffSiteBackups  = filter_var($input->getArgument(self::BIGSTORAGE_OFFSITEBACKUPS) ?? false, FILTER_VALIDATE_BOOLEAN);
