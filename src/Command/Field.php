...
class Field
{
    ...
    public const VPS_IDENTIFIER = 'VpsIdentifier';
    public const VPS_IDENTIFIER__DESC = 'The identifier of the vps';
    ...
    public const OPENSTACK_PROJECT_TYPE = 'Type';
    public const OPENSTACK_PROJECT_TYPE__DESC = 'Type of the project';
