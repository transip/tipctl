...
namespace Transip\Api\CLI\Command\DomainDefaults;
...
class UpdateContact extends AbstractCommand
{
    protected function configure(): void
    {
        $this->setName('domain-defaults:update-contact')
            ->setDescription('Update default WHOIS contact information for a customer')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $newContacts = [];
        $currentContacts = $this->getTransipApi()->defaultDomainContacts()->getAll();
        ...
        $this->getTransipApi()->defaultDomainContacts()->update($newContacts);
        return 0;
    }
}
